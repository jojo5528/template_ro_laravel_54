    ...
    <div class="row justify-content-center my-3">
        <div class="col">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <p class="text-center"><font size="5" color="blue">ก่อนทำการโอน กรุณาติดต่อ GM ก่อนทุกครั้ง และรอรับ Cash Point ภายใน 10 นาที</font></p>
                    <h5 class="text-center text-danger">
                        อัตราการโอนเงินระหว่างทรูวอลเล็ต & ธนาคาร ติดต่อโอนผ่านทางธนาคารและ Wallet ได้ที่
                        <a href="https://facebook.com/adminsureviptips" target="_blank">Facebook</a> หรือ Line ID = woero
                    </h5>
                    ...
                    <a href="{{ route('user.tmpay') }}" class="btn btn-lg btn-block btn-success"><i class="fas fa-star-exclamation fa-2x"></i> เติมเงินด้วยบัตรทรูมันนี่ คลิกเลย!</a>
                    <h5 class="text-center text-danger">อัตราการเติมเงินด้วยบัตร True Money ** แนะนำให้โอนผ่านทรูวอลเล็ต & ธนาคาร **</h5>
